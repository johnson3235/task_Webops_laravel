...
<tr>
 <td valign="top" align="left" width="100%" style="background:repeat-x url(https://www.filepicker.io/api/file/al80sTOMSEi5bKdmCgp2) #37474F;">
 <center>
        ...
        <td width="100%" height="48" valign="top">
            ...
            <![endif]-->
              <table class="full-width-gmail-android" cellspacing="0" cellpadding="0" border="0" width="100%">
                <tr>
                  <td class="header center" width="100%" style="color:#37474F;" >
                ...
                <table cellspacing="0" cellpadding="0" width="100%">
                  <tr>
                    <td class="left" style="padding-bottom:20px; text-align:left;">
                      Code <br> 
					  <p style="font-size: 25px; font-weight:bold;">{{ $code }}</p><br>
                    </td>
                  </tr>
                </table>
